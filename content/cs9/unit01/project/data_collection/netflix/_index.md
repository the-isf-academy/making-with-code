...
{{< code-action "Follow the steps below to download your Netflix watch history." >}} 
...
> 0. **Select `Account`.**
> 0. **Select `Profiles` on the left side.**
> 0. **Select your account under `Profile Settings`.**
> 0. **Select `Viewing activity`.**
