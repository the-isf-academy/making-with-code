---
Title: Project Story [ex]
# draft: true
---

# Unit 02 Games: Story Project [extended]
...
You will need to:<br>
1️⃣ create a UML diagram for the implmeentation of your new feature 
2️⃣ diagram the user interaction with a flow chart  
...
- **Planning** 
    ...
    - I can create a flow chart the user interaction of my story
    - I can create an accurate UML diagram of my new feature 
...
> To substantially demonstraete Feature Implementation, you must write a new class and integrate it into the `Story()` class.
