...
# Python Pyxel Intro Lab

In this lab you explore the Python Pyxel framework through example games.
...
{{< code-action >}} **Go to Settings > Security &  Privacy > Privacy. Scroll to Input Monitoring and add Terminal.** You will need to quit and re-open Terminal in order to save this preference.
